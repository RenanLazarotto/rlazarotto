...
<div class="my-6 not-prose">
	<div class="flex flex-col justify-center">
		<button on:click={open} class="max-h-[500px]">
			<img {src} {alt} class="max-h-[500px] h-full object-contain rounded cursor-pointer mx-auto" />
		</button>
		{#if $$slots.default}
...
>
	<img {src} {alt} class="rounded-lg max-w-full max-h-full h-auto self-center" />
	<button
