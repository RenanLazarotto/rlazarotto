<script lang="ts">
	...
	import type { Splide as SplideType, SplideSlide as SplideSlideType } from '@splidejs/svelte-splide';
...
>
	{#each images as image, i}
		<SplideSlide class="flex justify-center">
			...
			>
				<img src={image.src} alt={image.alt} class="h-full object-contain rounded" />
			</button>
		</SplideSlide>
	{/each}
</Splide>
