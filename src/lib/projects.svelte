    ...
    <table class="table-auto min-w-full cursor-default">
        <thead>
            <tr class="text-gray-500 font-bold">
                <th class="py-3 px-2 hidden sm:block">Ano</th>
                <th class="py-3 px-2 text-left">Título</th>
                <th class="py-3 px-2 text-left hidden sm:block">Feito em</th>
        ...
        <tbody>
            {#each projects as project}
                <tr class="hover:bg-gray-800">
                    <td
                        class="hidden sm:block font-medium text-center text-purple-500 py-3 px-2 rounded-l"
                        >{project.year}</td
                    >
                    <td class="py-3 px-2"
                    ...
                    >
                    <td class="hidden sm:block text-gray-500 py-3 px-2"
                        >{project.at}</td
                    >
