...
<section class="mb-12">
	<h2 class="font-bold text-3xl mt-5 mb-12 text-gray-100">Todas as publicações</h2>
	...
	<div class="flex flex-col gap-12">
		{#each data.posts as post}
			<a href={`/posts/${post.slug}`} class="flex flex-col lg:flex-row lg:items-center gap-4 group">
				...
				<div>
					<h2 class="text-2xl font-bold text-mint-300 group-hover:text-purple-400 transition-colors duration-200">
						{post.title}
					</h2>
